...
public class AdminController {
    ...
    public ModelAndView deleteClass( Model model, @RequestParam int id ) {
        ...
        for ( Person person : eazyClass.get().getPersons() ) { //Update all persons with class id as null value before detele class records
    ...
    public ModelAndView displayCourses( Model model ) {
        //Static sorting -> List<Courses> courses = coursesRepository.findByOrderByNameDesc();
